...
class ThirdViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate
{
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?)
    {
        ...
        fourthViewController.programDataTransfer = weekprogramData1
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int)
    {
        ...
        //..Quizas almacenar la seleccíon y transferirlo al otro View Controller..
    ...
    
    {
        ...
        weekprogramData1 = Weeks (Week: "Week1", Week1Low1: ["2", "3", "2", "2", "+3"], Week1Medium1: ["6", "6", "4", "4", "+5"], Week1High1: ["10", "12", "7", "7", "+9"])
        ...
        week5Day3Data = Weeks(Week: "WeekDay3", Week1Low1: ["15", "12", "12", "10", "+30"], Week1Medium1: ["20", "17", "17", "20", "+45"], Week1High1: ["24", "20", "20", "22", "50"])
